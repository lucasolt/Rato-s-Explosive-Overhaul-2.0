return PlaceObj('ModDef', {
	...
	'last_changes', "2.22a\n-Small tweak\n\n-Logic that generates deviated position for a throw was refactored, expect less wild and varied results\n-Also add a loop logic that determines the best angle trajectory for deviated grenades, so the grenade wont explode because a simple obstacle was in the way close to the unit\n-Performance gains\n-Heavy rain no longer decreases throw accuracy, instead it increases IED misfire chance\n-Dazed (flashbang) CTH penalty from -40 to -30\n-Increased shaped charge explosion angle\n-changes to try to prevent desync",
	'dependencies', {
